...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_LCTL, KC_LCTL, KC_LGUI, LOWER, KC_LSFT,   KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_DVORAK] = LAYOUT_planck_grid(
    ...
    BACKLIT, KC_LCTL, KC_LGUI, LOWER, KC_LSFT,   KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
